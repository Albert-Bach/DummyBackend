...
namespace InstallerBackend.Model
{
    ...
    { 
        ...
        public List<Technology> TechList { get; set; } = new List<Technology>
        {
            ...
            new Technology("c#", "Python", "https://www.python.org/ftp/python/3.6.4/python-3.6.4.exe", "python.exe" , "Not Installed", "/s InstallAllUsers=1 PrependPath=1", null),
            ...
            new Technology("javascript", "Python", "https://www.python.org/ftp/python/3.6.4/python-3.6.4.exe", "python.exe" , "Not Installed", "/quiet InstallAllUsers=1 PrependPath=1", null),
