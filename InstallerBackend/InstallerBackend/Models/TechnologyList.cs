...
namespace InstallerBackend.Model
{
    ...
    { 
        ...
        public List<Technology> TechList { get; set; } = new List<Technology>
        {
            ...
            new Technology("c#", "Python", "https://www.python.org/ftp/python/3.6.4/python-3.6.4.exe", "python.exe" , "3.6.6032.0", "/s InstallAllUsers=1 PrependPath=1", null),
            new Technology("java", "IntelliJ IDEA", "https://www.jetbrains.com/idea/download/#section=windows", "ii.exe" , "1.1.8", "installstring", null),
            new Technology("java", "javaSDK", "http://download.oracle.com/otn-pub/java/jdk/9.0.4+11/c2514751926b4512b076cc82f959763f/jdk-9.0.4_windows-x64_bin.exe", "jdk.exe" , "1.1.8", $"/s ADDLOCAL=\"ToolsFeature,SourceFeature,PublicjreFeature\"", null),
